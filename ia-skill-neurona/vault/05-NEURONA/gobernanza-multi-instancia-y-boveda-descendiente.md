...
La raíz del repo no es memoria viva; la bóveda del proyecto vive en un descendiente validado, normalmente `docs/`.
...
- Si la instancia publica salidas más legibles para humanos en otro espacio, `docs/` sigue siendo la fuente de verdad.

## Relación con la red

La normalización de objetos en `docs/` sigue el circuito `00-INBOX -> 01-CAPTURES -> 02-CONNECTIONS -> 03-BRIEFS -> 05-NEURONA`.
