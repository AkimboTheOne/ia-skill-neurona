...
Esta neurona resume el flujo operativo de `$mem` cuando lo usa un agente LLM. Guía el uso del módulo; no decide su implementación.
...
Si una etapa necesita detalle, ese detalle debe vivir en la guía específica de esa etapa, no en una repetición del loop completo.
