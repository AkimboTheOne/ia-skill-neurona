...
Si una instancia publica salidas más legibles para humanos, esas salidas pueden vivir fuera de `docs/`, pero la fuente de verdad sigue siendo la bóveda del proyecto.
...
`ia-skill-neurona/vault/` es la bóveda concreta del proyecto actual; `.tmp/` es memoria de trabajo del skill.
...
- [docs/ como bóveda concreta de la instancia actual del skill](20260514-102952-idea-el-repositorio-docs-de-este-proyecto-es-una-insta.md)
