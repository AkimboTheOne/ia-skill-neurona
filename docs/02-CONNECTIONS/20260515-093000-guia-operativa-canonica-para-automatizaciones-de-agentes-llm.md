...
- [Índice de ayuda operativa para agentes LLM](../05-NEURONA/indice-de-ayuda-operativa-para-agentes-llm.md)
- [Flujo completo de automatización para agentes LLM](../05-NEURONA/flujo-completo-de-automatizacion-para-agentes-llm.md)
- [Criterios para no confundir operación con implementación](../05-NEURONA/criterios-para-no-confundir-operacion-con-implementacion.md)
