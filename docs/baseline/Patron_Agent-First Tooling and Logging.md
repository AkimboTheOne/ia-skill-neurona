...
source_file: docs/baseline/Patron_Agent-First Tooling and Logging.md
reference: https://www.sourcegraph.com
tags:
  - baseline
  - tooling
  - logging
...
Fuente histórica sobre tooling y logging para agentes. La superficie operativa curada está en la [Fuente consolidada de `docs/baseline`](../01-CAPTURES/patterns/20260513-172100-baseline-source-consolidated.md).

## Síntesis

Este patrón sostiene que el entorno debe priorizar legibilidad por máquinas: registro unificado, salidas estructuradas, CLIs conscientes del agente y protocolos estándar como MCP.
