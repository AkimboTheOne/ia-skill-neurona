...
source_file: docs/baseline/Patron_LLM-Friendly API Design.md
...
Fuente histórica sobre diseño de APIs para LLM. La superficie operativa curada está en la [Fuente consolidada de `docs/baseline`](../01-CAPTURES/patterns/20260513-172100-baseline-source-consolidated.md).

## Síntesis

Este patrón insiste en APIs explícitas, versionadas, autodescriptivas y con errores accionables para reducir ambigüedad y costo de uso por agentes.
