...
Artículo original histórico que inspira la arquitectura de memoria de `$mem`. La fuente validada es un X article; la superficie operativa curada está en la [Fuente consolidada de `docs/baseline`](../01-CAPTURES/patterns/20260513-172100-baseline-source-consolidated.md).
