...
source_file: docs/baseline/Patron_CLI-First Skill Design.md
...
# Diseño de skills primero CLI

## Curaduría

Fuente histórica sobre diseño de skills centrados en CLI. La superficie operativa curada está en la [Fuente consolidada de `docs/baseline`](../01-CAPTURES/patterns/20260513-172100-baseline-source-consolidated.md).

## Síntesis

El patrón recomienda tratar cada skill como una herramienta CLI de uso dual para humanos y agentes, con salida estructurada, código de salida claro y composición tipo Unix.

Design all skills as CLI tools first for dual-use by humans and agents, enabling manual debugging, programmatic invocation, composition with Unix tools, and transparent shell-based execution without building separate interfaces.
