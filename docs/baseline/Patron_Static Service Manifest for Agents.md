...
source_file: docs/baseline/Patron_Static Service Manifest for Agents.md
...
Fuente histórica sobre manifiestos estáticos para agentes. La superficie operativa curada está en la [Fuente consolidada de `docs/baseline`](../01-CAPTURES/patterns/20260513-172100-baseline-source-consolidated.md).

## Síntesis

El patrón propone publicar `llms.txt` y `agent.json` como mapas de entrada ligeros para que el agente descubra capacidades sin gastar contexto en documentación completa.
