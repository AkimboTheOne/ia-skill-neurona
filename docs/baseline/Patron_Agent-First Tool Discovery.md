...
source_file: docs/baseline/Patron_Agent-First Tool Discovery.md
...
Fuente histórica sobre descubrimiento de herramientas para agentes. La superficie operativa curada está en la [Fuente consolidada de `docs/baseline`](../01-CAPTURES/patterns/20260513-172100-baseline-source-consolidated.md).

## Síntesis

Este patrón propone índices de búsqueda diseñados para consumidores agentes, con metadatos estructurados y ranking por señales relevantes para el agente, no por métricas de SEO humano.
