...
```mermaid
flowchart TD
    IN[00-INBOX] --> CAP[01-CAPTURES]
    CAP --> CON[02-CONNECTIONS]
    CON --> BR[03-BRIEFS]
    BR --> N[05-NEURONA]

    N --> V[Validar contra el core]
    V --> OK{¿No contradice el core?}
    OK -- Sí --> USE[Usar como guía operativa]
    OK -- No --> DEV[Queda en implementación o contrato]
```
...
- [Guía operativa canónica para automatizaciones de agentes LLM](../02-CONNECTIONS/20260515-093000-guia-operativa-canonica-para-automatizaciones-de-agentes-llm.md)
