...
tags:
  ...
  - llm
aliases:
  - Índice de ayuda operativa para agentes LLM
---
...
La red de ayuda sirve al operador del módulo, no al implementador del skill. Cada neurona debe mantener esa frontera.
